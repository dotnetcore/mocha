...
public class SpanLinkAttributeConfiguration : IEntityTypeConfiguration<EFSpanLinkAttribute>
{
    public void Configure(EntityTypeBuilder<EFSpanLinkAttribute> builder)
    {
        ...
        builder.Property(e => e.SpanLinkIndex).HasColumnName("span_link_index").IsRequired();
